<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="java.util.*,xin.yohuyotu.HelloWorld.bean.User" 
...
<body>
	<%String path=request.getContextPath()+"/backUser?method=all"; %>
	<%String path2=request.getContextPath()+"/backUser?method=deleteLogistics"; %>
	<%String path3=request.getContextPath()+"/backUser?method=deleteCard"; %>
	<%String path4=request.getContextPath()+"/backUser?method=deleteUser"; %>
	...
	%>
		<tr>
			...
			<td><button class="logistics" id="<%=o.getUsername() %>">清空物流</button></td>
			<td><button class="card" id="<%=o.getUsername() %>">清空卡卷信息</button></td>
			<td><button class="user" id="<%=o.getUsername() %>">删除用户</button></td>
		</tr>
	<%} %>
	</table>
