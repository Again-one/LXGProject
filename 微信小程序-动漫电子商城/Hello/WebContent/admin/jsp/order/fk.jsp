...
<body>
	<%String path=request.getContextPath()+"/back?method=fKOrder"; %>
	<%String path3=request.getContextPath()+"/back?method=fHRequest"; %>
	<%String path2=request.getContextPath()+"/backGoods?method=allOrder"; %>
	...
	%>
		<tr>
			...
			<td><%=o.username %></td>
			<td><%=o.message %></td>
			<td ><button class="fahuo" id="<%=o.oid %>" >发货</button>
			<td ><button class="zsxq" id="<%=o.oid %>" >展示详情</button>
			</td>
		</tr>
	<%} %>
	</table>
