<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="java.util.*,xin.yohuyotu.HelloWorld.bean.Goods" 
...
<body>
	<%String path=request.getContextPath()+"/backGoods?method=all"; %>
	...
	%>
		<tr>
			<td><%=o.getId() %></td>
			<td><img src="<%=request.getContextPath() %>/image/<%=o.getPicture()%>_1.jpg" style="width:50px;height:50px"></td>
			<td><%=o.getSummary()%></td>
			<td><%=o.getPrice() %>元</td>
			<td><%=o.getPay() %></td>
			<td><% for(int j=0;j<o.getSize();j++){%>
			<a href="<%=request.getContextPath()%>/image/detail/<%=o.getPicture()%>_<%=j %>.jpg">
				<img  style="width:50px;height:50px;" src="<%=request.getContextPath()%>/image/detail/<%=o.getPicture()%>_<%=j %>.jpg">
			</a>
